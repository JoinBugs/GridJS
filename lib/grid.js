    ...
    (function () 
    {
							 ...
							 function( row, index_row )
									{
										...
										for( var e in item )
										{
								            ...
								            cells[ index_col ].setAttribute( 'class',  'col ' + e );
											index_col++;
										}
										e = ' ' + e;
								        if( columns.length > 2 )
								        	e = '';
								        row.setAttribute( 'class', 'row' + e );
									});
        ...
        initResponsive = function( table )
        {
        	window.addEventListener( 'resize', function( e ) 
        	{
        		...
        		// mode responsive
        		if( window.innerWidth < 768 && table.classList.contains( 'tblFull' ) )
        		{
        		...
        		// mode full table
        		else if ( window.innerWidth > 767 && table.classList.contains( 'tblResponsive' ) )
        		{
        			classes += ' tblFull';
        ...
        {
        	window.changeAsTwoColumns = changeAsTwoColumns;
