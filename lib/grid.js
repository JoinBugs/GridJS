    ...
    (function () 
    {
				...
				*/
				...
				updateData = function( args  )
				{
					var data 	= args.data, 
						...
						CALL_RESPONSIVE = args.CALL_RESPONSIVE;
        ...
        changeModeTable = function( table )
        {
        	var params     = table.params,
        		...
        		{
        			table.updateData({
        				'data' : changeAsTwoColumns( paramsUser.data,
        ...
        {
        	//check params and add properties if these ones is not in the object's params the otherwise its not anything
        	checkParams( params );
